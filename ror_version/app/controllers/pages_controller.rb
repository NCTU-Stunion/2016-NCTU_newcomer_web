class PagesController < ApplicationController
  ...
  def alumnian
    ...
    @data = [ { "name" => "高雄屏東校友會(雄友會)", "pdf" => "none", "web" => "none", "fb" => "https://www.facebook.com/groups/1793049137607116/ ", "img" => "雄友.jpg" ,"color"=>"white"},
              { "name" => "台南地區校友會(南友會)", "pdf" => "none", "web" => "none", "fb" => "https://www.facebook.com/NCTU.TN", "img" => "台南地區校友會(南友會).jpg","color"=>"default" },
              { "name" => "嘉義雲林校友會(雲嘉會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "嘉義雲林校友會(雲嘉會).jpg" ,"color"=>"default"},
              { "name" => "中部校友會(中友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "中部校友會(中友會).jpg" ,"color"=>"white"},
              { "name" => "竹苗地區校友會(竹友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "竹苗地區校友會(竹友會).jpg" ,"color"=>"white"},
              { "name" => "桃園地區同鄉會(桃友會)", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "桃園地區同鄉會(桃友會).jpg","color"=>"default"},
              { "name" => "建中北一女校友會(建北會)", "pdf" => "none", "web" => "none", "fb" => "https://www.facebook.com/pages/2015%E6%B8%85%E4%BA%A4%E5%BB%BA%E5%8C%97%E8%81%AF%E5%90%88%E8%BF%8E%E6%96%B0%E5%AE%BF%E7%87%9F/864703153565678", "img" => "建中北一女校友會(建北會).jpg" ,"color"=>"white"},
              { "name" => "北部校友會(北友會)", "pdf" => "none", "web" => "none", "fb" => "https://www.facebook.com/NCTUBYsummercamp.alwaysbewithyou", "img" => "北部校友會(北友會).jpg" ,"color"=>"white"},
