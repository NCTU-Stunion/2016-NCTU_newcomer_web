class PagesController < ApplicationController
  def curricular
    ...
    @data = [ { "name" => "國際標準舞社", "pdf" => "國標.pdf", "web" => "none", "fb" => "https://www.facebook.com/groups/1793049137607116/", "img" => "國標.jpg" , "color" => "default"},
              ...
              { "name" => "文化服務團", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" , "color"=> "default"},
              ...
              { "name" => "信望愛社", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" , "color" => "default"},
  ...
  def studentAssociation
    @title = "系學會 | 網路新生包"
    @data = [ { "name" => "電機資訊學士班", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "奈米科學及工程學士學位學程", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "電子工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "電機工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "光電工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "資訊工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "材料科學與工程學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "機械工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "土木工程學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "電子物理學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "應用化學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "應用數學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "生物科技學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "資訊管理與財務金融學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "管理科學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "運輸與物流管理學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "工業工程與管理學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "外國語文學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "傳播與科技學系", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "人文社會學系", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"}]
  end
  def alumnian
    @title = "友會列表 ｜ 網路新生包"
    @data = [ { "name" => "高雄屏東校友會(雄友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "台南地區校友會(南友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "嘉義雲林校友會(雲嘉會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "中部校友會(中友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "竹苗地區校友會(竹友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "武陵高中校友會(武友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "桃園地區同鄉會(桃友會)", "pdf" => "none", "web" => "none", "fb" => "none" , "img" => "none"},
              { "name" => "建中北一女校友會(建北會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
              { "name" => "北部校友會(北友會)", "pdf" => "none", "web" => "none", "fb" => "none", "img" => "none" },
